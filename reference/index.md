...
- [`double_exponential()`](https://github.com/ndpvh/discounting-affect/reference/double_exponential.md)
  :

  Constructor for the
  [`double_exponential-class`](https://rdrr.io/pkg/discounting/man/double_exponential-class.html)

- [`exponential-class`](https://github.com/ndpvh/discounting-affect/reference/exponential-class.md)
  : Exponential Class

- [`exponential()`](https://github.com/ndpvh/discounting-affect/reference/exponential.md)
  :
...
- [`model()`](https://github.com/ndpvh/discounting-affect/reference/model.md)
  :
...
- [`quasi_hyperbolic()`](https://github.com/ndpvh/discounting-affect/reference/quasi_hyperbolic.md)
  :
